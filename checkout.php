        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active" href="checkout.html">Checkout</span>
                </nav>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            <div class="col-lg-8">
                ...
                <form name="" id="" novalidate="novalidate" method="post">
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label>First Name</label>
                            <input class="form-control"  required="required" data-validation-required-message="Please enter your name"type="text" placeholder="Name">
                        </div>
                        <div class="col-md-6 form-group">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" type="text" placeholder="+92123 456 789">
                        </div>
                        <div class="col-md-6 form-group">
                        ...
                        <div class="col-md-6 form-group">
                            <label>City</label>
                            <input class="form-control" type="text" placeholder="Karachi">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>State</label>
                            <input class="form-control" type="text" placeholder="Pakistan">
                        </div>
                        <div class="col-md-6 form-group">
                    ...
                    <div class="bg-light p-30">
                        <div class="form-group">
                            <div class="custom-control custom-radio">
                                ...
                                <label class="custom-control-label" for="paypal">Jazz Cash</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="payment" id="directcheck">
                                <label class="custom-control-label" for="directcheck">Easy Paisa</label>
                            </div>
                        </div>
                        ...
                        <button onclick= "my()" class="btn btn-block btn-primary font-weight-bold py-3">Place Order</button>
