...
<head>
    ...
    <link href="css/style2.css" rel="stylesheet">s
</head>
            ...
            <div class="col-lg-7 mb-5">
                <div class="contact-form bg-light p-30">
                    ...
                    <form name="" id="" novalidate="novalidate" method="post">
                        ...
                        <div>
                            <button class="btn btn-primary py-2 px-4" name="btncontactone" type="submit" id="">Send
                                Message</button>
                                <!-- <button type="submit" name= "btncontactone" value="insert">Message</button> -->
                        </div>
                    </form>
                    <?php

if(isset($_POST['btncontactone']))
{
  $name = $_POST['name'];
  $email = $_POST['email'];
  $sub = $_POST['subject'];
  ...
  $query = "INSERT INTO tbl_contact VALUES ('$name','$email','$sub','$msg')";
...
?>
            ...
            <div class="col-lg-5 mb-5">
                ...
                <div class="bg-light p-30 mb-3">
                    ...
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary mr-3"></i>+92 3121184286</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <form action="">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <button href="R" class="btn btn-primary">Sign Up</button>
                                </div>
                            </div>
                        </form>
