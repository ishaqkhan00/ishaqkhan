...
<body>
    <h1 style="text-align: center; color: #000;">Login For admin</h1>
        ...
        <div class="login-html">
            ...
            <div class="login-form">
                <div class="sign-in-htm">
                    ...
                    <div class="group">
                        <input type="submit" class="button" name="btnreg" value="Admin Login">
                    </div>
                    <div class="hr"></div>
                    <div class="foot-lnk">
...
if(isset($_POST['btnreg']))
{
  ...
  $query = "SELECT * FROM tbl_login WHERE User_name = '$uname' and User_password = '$upass'";
